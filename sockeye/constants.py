...
PAD_FORMAT = "<pad%d>"
TOKEN_SEPARATOR = " "
VOCAB_SYMBOLS = [PAD_SYMBOL, UNK_SYMBOL, BOS_SYMBOL, EOS_SYMBOL, CTX_SYMBOL]
...
MODEL_TYPE_SUM_EMB_ADD = "sum_emb_add"
MODEL_TYPE_AVG_DOC_ATTN = "avg_emb_doc_attn"
MODEL_TYPE_WEAVER = "ctx_doc_weaver"
MODEL_TYPE_AVG_MAX_EMB_ADD = "avg_max_emb_add"
MODEL_TYPE_PRE_AVG = "avg_emb_add_pre"
MODEL_TYPES = [MODEL_TYPE_CTX_DEC, MODEL_TYPE_CTX_ENC, MODEL_TYPE_AVG_EMB_TOK, MODEL_TYPE_AVG_EMB_ADD, MODEL_TYPE_MAX_EMB_TOK, MODEL_TYPE_MAX_EMB_ADD, MODEL_TYPE_SUM_EMB_ADD, MODEL_TYPE_AVG_DOC_ATTN, MODEL_TYPE_WEAVER, MODEL_TYPE_AVG_MAX_EMB_ADD, MODEL_TYPE_PRE_AVG]
...
INFERENCE_ARG_CTX_INPUT_LONG = "--ctx-input"
INFERENCE_ARG_DOC_INPUT_LONG = "--doc-input"
...
OUTPUT_HANDLER_MULTI_SCORE = "multi_score"
...
OUTPUT_HANDLERS_SCORING = [OUTPUT_HANDLER_SCORE,
                           OUTPUT_HANDLER_PAIR_WITH_SCORE, OUTPUT_HANDLER_MULTI_SCORE]
