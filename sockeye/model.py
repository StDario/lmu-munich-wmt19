...
class ModelConfig(Config):
    ...
    def __init__(self,
                 ...
                 lhuc: bool = False,
                 load_ctx_params_from_base: bool = False,
        ...
        self.load_ctx_params_from_base = load_ctx_params_from_base
...
class SockeyeModel:
    ...
    def __init__(self, config: ModelConfig, prefix: str = '') -> None:
        ...
        if isinstance(self.config.config_embed_source, encoder.PassThroughEmbeddingConfig):
            ...
            self.ctx_embedding_source = encoder.Embedding(self.config.config_embed_source,
                                                          ...
                                                          embed_weight=embed_weight_ctx_source, is_source=True)
    ...
    def load_params_from_file(self, fname: str):
        ...
        if hasattr(self, 'load_ctx_params_from_base') and self.load_ctx_params_from_base:
            self.params, self.aux_params = utils.load_ctx_from_base_params(fname)
        else:
    ...
    def _get_embed_weights(self, prefix: str) -> Tuple[mx.sym.Symbol, mx.sym.Symbol, mx.sym.Symbol, mx.sym.Symbol]:
        """
